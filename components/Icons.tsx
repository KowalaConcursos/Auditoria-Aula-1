...
export const TrophyIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 12.75v6.75" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75a4.5 4.5 0 10-9 0 4.5 4.5 0 009 0zM12 3.75v-1.5" />
  </svg>
);
...
export const ShareIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.05.588.08m-5.858 3.69a2.25 2.25 0 012.186 0c.195.025.39.05.588.08m-2.186 0l-5.858 3.69m5.858-3.69v-5.858c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v5.858m0 0a2.25 2.25 0 100-2.186m0 2.186l5.858-3.69m-5.858 3.69c-.195-.025-.39-.05-.588-.08m5.858 3.69c.195-.025.39-.05.588-.08M14.25 12a2.25 2.25 0 10-4.5 0 2.25 2.25 0 004.5 0z" />
    </svg>
);
